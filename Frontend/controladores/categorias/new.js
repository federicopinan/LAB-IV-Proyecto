import {categoriasServices} from '/Frontend/servicios/categorias-servicios.js'
...
function guardar(e) {
    ...
    categoriasServices
        .crear(values.nombre, values.descripcion)
        .then(respuesta => {
            formulario.reset()
...
function modificar(e) {
    ...
    categoriasServices
        .editar(catId, values.nombre, values.descripcion)
        .then(respuesta => {
            formulario.reset()
            window.location.href = '#/categorias'
        })
