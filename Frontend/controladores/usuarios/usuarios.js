...
const htmlUsuarios = `<div class="card">
...
export async function Usuarios() {
    ...
    res.forEach(element => {
        element.action =
            ...
            element.id +
            "'> <i class='fas fa-pencil-alt'></i></a><a class='btn btn-danger btn-sm rounded-circle removeItem btnBorrarUsuario'href='#/delUsuario' data-idUsuario='" +
            element.id +
